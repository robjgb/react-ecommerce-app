...
const ORDER_TABLE = "Order-qne4hjpdlfb53cybywvy4ulwpy-dev";
const ORDER_TYPE = "Order";
const PRODUCT_ORDER_TABLE = "ProductOrder-qne4hjpdlfb53cybywvy4ulwpy-dev";
 ...
 * Create an order
 * Link product to the order - Users can see the past orders and admins can view orders by user
